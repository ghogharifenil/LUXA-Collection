...
# # Genrate PDF Dowonloder Import Moduls 
...
# def generate_invoice_pdf(customer, orders, total):

#     buffer = BytesIO()
#     p = canvas.Canvas(buffer)

#     p.drawString(100, 800, "LUXA COLLECTION INVOICE")
#     p.drawString(100, 770, f"Customer: {customer.name}")

#     y = 720

#     for order in orders:
#         p.drawString(100, y, f"{order.product.name} - ₹{order.total_price}")
#         y -= 20
...
# def send_order_email( request ,customer_id, name, orders, total):

#     customer = CustomerModel.objects.get(id=customer_id)
#     user_email = customer.email

#     invoice_url = request.build_absolute_uri(
#     reverse("download_invoice", args=[customer_id])
# )
...
#     pdf_file = generate_invoice_pdf(customer, orders, total)
...
#     email.attach_alternative(html_content, "text/html")
#     email.attach("LUXA_Invoice.pdf", pdf_file, "application/pdf")
#     email.send()
...
#         # 🔥 FIX 3: correct total pass
#         send_order_email(request, customer_id, name, orders, total)
...
#     pdf_path = f"media/invoices/bill_{customer_id}.pdf"

#     return FileResponse(
#         open(pdf_path, "rb"),
#         as_attachment=True,
#         filename="LUXA_Invoice.pdf"
#     )
